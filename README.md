...
- [Encriptador de nóminas automático](enlace) - Para suplir la necesidad de una asesoría laboral, he realizado un pequeño programa en **Python**, el cual tiene la función de encriptar las nóminas siguiendo como criterio el 70% de concordancia en el nombre del fichero pdf dque genera el programa A3Nom, asignándosele así a través de un fichero CSV el cual contiene una relación del nombre de trabajadores y contraseñas asignadas, y de esta forma, encripte todas esas nóminas y guarde las mismas en la ruta asignada. El fichero CSV, es posible modificarlo directamente desde la interfaz del programa, pudiendo eliminar y añadir nuevos registros.
